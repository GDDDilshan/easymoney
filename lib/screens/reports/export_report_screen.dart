      ...
      pw.Page(
        build: (context) => pw.Column(
          ...
          children: [
            ...
            // Bottom Section - Professional Brand Footer
            pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.center,
              children: [
                // Divider
                pw.Divider(thickness: 1.5, color: PdfColor.fromHex('#DDDDDD')),
                pw.SizedBox(height: 16),

                // Brand Section with Premium Styling
                pw.Container(
